<?php
/**
 * Manual Attendees: Edit form buttons section.
 *
 * Override this template in your own theme by creating a file at:
 * [your-theme]/tribe/tickets-plus/manual-attendees/edit/buttons.php
 *
...
<div class="tribe-tickets__manual-attendees-form-buttons">
	<button
		...
		type="submit"
	>
		<?php esc_html_e( 'Update Attendee', 'event-tickets-plus' ); ?>
	</button>
</div>
