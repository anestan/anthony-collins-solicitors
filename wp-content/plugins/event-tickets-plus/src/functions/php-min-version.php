...
function tribe_not_php_version_message() {
	...
	$last_connector = esc_html_x( ' and ', 'Plugin A "and" Plugin B', 'event-tickets-plus' );
	$many_connector = esc_html_x( ', ', 'Plugin A"," Plugin B', 'event-tickets-plus' );
	...
	return wp_kses_post( sprintf(
		...
		'<br />' .
		esc_html__( 'To allow better control over dates, advanced security improvements and performance gain.', 'event-tickets-plus' ) .
		'<br />' .
		esc_html__( 'Contact your Host or your system administrator and ask to upgrade to the latest version of PHP.', 'event-tickets-plus' );
}
