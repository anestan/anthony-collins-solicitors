...
/**
 * The Event Tickets Plus ORM/Repository decorator for RSVP attendees.
 *
 * @since 5.2.0
 *
 * @property \Tribe__Tickets__Repositories__Attendee__RSVP $decorated
 */
class RSVP extends Tribe__Repository__Decorator {
	 ...
	 * RSVP constructor.
	 *
	 * Gets the current ET RSVP repository instance to extend.
	 *
	 * @since 5.2.0
	 */
	public function __construct() {
		$this->decorated = tribe( 'tickets.attendee-repository.rsvp' );
